...
数据规模：476 MB / 51,705 个文件+目录（npm node_modules，3 轮平均）

| 排名 | 删除方式 | 耗时 | 相对 rmx |
|:---:|:---:|:---:|:---:|
| 🥇 | **⚡ rmx** | **4,120 ms** | **1.00x** |
| 🥈 | cmd rmdir /s /q | 7,496 ms | 慢 1.82x |
| 🥉 | PowerShell Remove-Item | 7,623 ms | 慢 1.85x |
| 4 | Git Bash rm -rf | 8,394 ms | 慢 2.04x |
